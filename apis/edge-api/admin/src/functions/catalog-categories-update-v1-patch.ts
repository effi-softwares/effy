// PATCH /admin/v1/catalog/categories/{id} — edit name/parent/order. Mutate access.
...
import { updateCategory } from "../catalog/service";
...
export const handler = async (
  ...
  try {
    return json(200, toCategoryDTO(await updateCategory(event.pathParameters?.id ?? "", parsed.value, g.sub)), scope);
  } catch (err) {
