// POST /admin/v1/catalog/product-types — create a product type. Mutate access.
...
import { createProductType } from "../catalog/service";
...
export const handler = async (
  ...
  try {
    return json(201, toProductTypeDTO(await createProductType(parsed.value, g.sub)), scope);
  } catch (err) {
