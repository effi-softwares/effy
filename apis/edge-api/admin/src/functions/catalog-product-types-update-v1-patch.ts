// PATCH /admin/v1/catalog/product-types/{id} — edit name/description. Mutate access.
...
import { updateProductType } from "../catalog/service";
...
export const handler = async (
  ...
  try {
    return json(200, toProductTypeDTO(await updateProductType(event.pathParameters?.id ?? "", parsed.value, g.sub)), scope);
  } catch (err) {
