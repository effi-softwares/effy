// POST /admin/v1/delivery-declarations/{id}/decline — 032 FR-024/FR-025/FR-026.
...
import { decline } from "../delivery/approvals";
...
export const handler = async (
  ...
  try {
    const review = await decline(event.pathParameters?.id ?? "", parsed.value ?? {}, g.sub);
