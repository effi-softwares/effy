// POST /admin/v1/delivery-declarations/{id}/revoke — 032 FR-024/FR-025/FR-026.
...
import { revoke } from "../delivery/approvals";
...
export const handler = async (
  ...
  try {
    const review = await revoke(event.pathParameters?.id ?? "", parsed.value ?? {}, g.sub);
