...
describe("createPromo", () => {
  it("audits the creation inside the same transaction as the insert", async () => {
    ...
    await createPromo(
      { code: "SPRING20", kind: "percentage", percentOff: 20, amountOff: null, minimumSubtotalAmount: "0.00", startsAt: null, endsAt: null, maxRedemptions: null, maxPerCustomer: null },
      "actor",
    );
