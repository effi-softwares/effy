// POST /inventory/v1/products/{productId}/stock/adjustments — record a relative change (054 US1, FR-006).
...
export const handler = async (
  ...
  try {
    return json(200, await service.adjustCount(g.actor, productId, parsed.value), g.scope);
  } catch (err) {
