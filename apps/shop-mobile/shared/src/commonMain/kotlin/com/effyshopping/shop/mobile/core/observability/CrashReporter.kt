 ...
 * behind a platform boundary, exactly like [com.effyshopping.shop.mobile.core.auth.AuthDriver]:
 * ONE interface in commonMain, a real implementation per target (Android = Firebase Android SDK; iOS =
 * a Swift bridge injected at the entry point). Wired into [com.effyshopping.shop.mobile.app.AppContainer].
 *
