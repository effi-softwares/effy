...
// The EMAIL_OTP flow is identical on every pool, so it lives in the kit. What is surface-specific
// is the SHAPE of a session — which role union it narrows the `cognito:groups` claim to.
