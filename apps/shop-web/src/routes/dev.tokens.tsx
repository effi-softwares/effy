 ...
 *
 * ⚠ REGISTERED ONLY UNDER `import.meta.env.DEV` (see router.tsx), and in no sidebar. It is a
 * developer tool, not a feature: shipping it would put a page of colour swatches inside a console
 * whose nav the operator reads at a glance.
 *
