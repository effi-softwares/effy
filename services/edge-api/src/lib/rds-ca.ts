// GENERATED — do not edit. The ap-southeast-1 RDS certificate-authority bundle
// (PUBLIC certificates, not secrets), embedded so esbuild ships it inside every
// function bundle with zero packaging patterns. Regenerate when AWS rotates CAs:
//   curl -sf https://truststore.pki.rds.amazonaws.com/ap-southeast-1/ap-southeast-1-bundle.pem
// (3 certificates as of 2026-07: rds-ca-rsa2048-g1, rds-ca-rsa4096-g1, rds-ca-ecc384-g1)
