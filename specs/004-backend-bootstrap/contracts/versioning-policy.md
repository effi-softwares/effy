# Contract: API Versioning Policy

**Binding on**: every externally consumed endpoint of `core-api` and `edge-api`.
**Ships as**: `docs/api/versioning-policy.md`. **Decisions**: research.md A1–A5
(industry survey: Google AIP-185/180, GitHub, Shopify, Stripe, Uber, Zalando, RFC
9745/8594/9457).
